<template>
    ...
    >                    
        <v-row class="mt-0">        
            <v-col cols="12" md="3" :class="`sidepane position-fixed pt-0 pb-0 pr-0 w-100 ${mdAndUp ? '' : 'elevation-5'}`">
                <slot name="sidepane">
                    <v-sheet
                        class="pa-4 pt-md-8 text-center d-flex d-md-block"
                    ...
                    <v-list class="d-flex justify-center justify-md-start d-md-block py-0">
                        <v-list-item              
            ...
            <v-col cols="12" offset-md="3" md="9" class="px-8 pl-md-4 pr-md-8 pt-0 pt-md-4 pb-10 mt-16 mt-md-4">                    
                <v-breadcrumbs :items="breadcrumbs" class="px-0 mx-0 mt-16 mt-md-0 pt-16 pt-md-0">
